    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContenuPanierId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PanierId = table.Column<int>(type: "int", nullable: false),
                    ProduitId = table.Column<int>(type: "int", nullable: false),
                    Quantite = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_contenuPaniers", x => x.ContenuPanierId);
                    table.ForeignKey(
                        name: "FK_contenuPaniers_Panier_PanierId",
                        column: x => x.PanierId,
                        principalTable: "Panier",
                        principalColumn: "PanierId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_contenuPaniers_Produits_ProduitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_contenuPaniers_PanierId",
                table: "contenuPaniers",
                column: "PanierId");

            migrationBuilder.CreateIndex(
                name: "IX_contenuPaniers_ProduitId",
                table: "contenuPaniers",
                column: "ProduitId");
